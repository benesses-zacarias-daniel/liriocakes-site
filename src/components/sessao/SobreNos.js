...
const SobreNos = () => {
    ...
    const Valores = [
        {
            "id": 1,
            "passo": "Qualidade",
            "desc": "Utilizamos ingredientes cuidadosamente escolhidos para garantir o melhor sabor.",
            "alt": "Ícone de Bolo",
            "src": Cake
        }, {
            "id": 2,
            "passo": "Criatividade",
            "desc": "Valorizamos cada cliente e procuramos oferecer uma experiência acolhedora.",
            "alt": "Ícone de Mensagem",
            "src": Mensagem
        }, {
            "id": 3,
            "passo": "Compromisso",
            "desc": "Trabalhamos para que os pedidos cheguem frescos e no menor tempo possível.",
    ...
    return (
        <div className={style.sobre}>
            ...
            <HistoriaSobre />
            <Passos titulo={"Nossos Valores"} minInfo={"Levar sabor, qualidade e felicidade aos nossos clientes através de produtos feitos com carinho."} dados={Valores} />
